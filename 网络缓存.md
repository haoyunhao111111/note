...
![从服务端请求文件所消耗的时间](https://s0.lgstatic.com/i/image/M00/31/4D/CgqCHl8MKQyAOi4qAAAqnHUKGOQ421.png)

从缓存中获取文件所消耗的时间

![从缓存中获取文件所消耗的时间](https://s0.lgstatic.com/i/image/M00/31/42/Ciqc1F8MKRaAVJdKAAAsNYhLc68530.png)
...
![响应头部中的 Expires 信息](https://s0.lgstatic.com/i/image/M00/31/42/Ciqc1F8MKT-AbvemAAAGfctSoow363.png)
...
1. 使用限制越强大的东西往往越危险，所以浏览器对 ServiceWorker 做了很多限制：
